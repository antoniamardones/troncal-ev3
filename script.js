            ...
            new Chart(document.getElementById("otro"), {
                ...
                data: {
                    ...
                    datasets: [
                        {
                            label: "Programas universitarios de Diseño",
                            data: [1, 0, 2, 0, 1, 6, 32, 0, 1, 1, 3, 1, 1, 0, 0, 0],
                            backgroundColor: "rgba(241,142,45,.75)",
                        ...
                        tooltip: {
                            ...
                            callbacks: {
                                label: function (context) {
                                    ...
                                    const pct = ((v / 49) * 100).toFixed(1);
                                    return v + " programa" + (v > 1 ? "s" : "") + " (" + pct + "% del total nacional)";
                                },
                            },
                        },
                    },
